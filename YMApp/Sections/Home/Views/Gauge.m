...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        gaugeView= [UIImage imageNamed:@"quot;gaugeback.pn"];
        //添加指针
//        UIImage *_pointer = [UIImage imageNamed:@"pointer2.png&quot"];
//        pointer = [[UIImageView alloc] initWithImage:_pointer];
        ...
        pointer.center = CGPointMake((CGRectGetWidth(self.bounds) - CGRectGetMinX(self.bounds))/2, (CGRectGetHeight(self.bounds) - CGRectGetMinY(self.bounds))/2);
...
-(void)setTextLabel:(NSInteger)labelNum
{
    ...
    CGFloat radius = (self.bounds.size.width/2 - 75)*scoleNum;
    CGFloat currentAngle;
    CGFloat currentText = 0.0f;
    CGPoint centerPoint = CGPointMake((CGRectGetWidth(self.bounds) - CGRectGetMinX(self.bounds))/2, (CGRectGetHeight(self.bounds) - CGRectGetMinY(self.bounds))/2);
